...
export const LEVELS: Level[] = [
  {
    id: 1,
    name: "Новичок",
    description: "Привет! Сегодня твой первый день в команде поддержки. Твоя цель - накапливать знания по продуктам Контура, активно задавать вопросы наставнику и погружаться в жизнь IT-компании. Удачи!",
    goals: [
  ...
  },
  {
    id: 2,
    name: "Консультант",
    description: "Обучение позади — теперь начинается настоящее приключение! Клиентам нужна твоя помощь по продуктам Контура. Вперёд, консультант! Мы рассчитываем на тебя.",
    goals: [
      {
        figure: "goldenCell",
        target: 9,
