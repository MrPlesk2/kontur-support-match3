...
export const LEVELS: Level[] = [
  {
    id: 1,
    name: "Новичок",
    description: "Сегодня твой первый день в команде поддержки. Твоя цель - накапливать знания по продуктам Контура, активно задавать вопросы наставнику и погружаться в жизнь IT-компании. Удачи!",
    goals: [
  ...
  },
  {
    ...
    description: "Собирай фигуры по три в ряд и получай как можно больше очков! Выполняй цели, чтобы получить случайные бонусы, и продолжай улучшать свой результат.",
    goals: [
